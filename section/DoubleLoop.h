...
class DoubleLoop : public SectionManager {
    ...
    private:
        ...
        SecParam spara [100] = {
            ...
            {Section::TRACER,{21, -0.2,  17, 12, 8,0,0,LineTracer::LEFTEDGE},Section::COLOR,{228,0.16},Section::NONE,{}},//髱偵?槭?ｼ繧ｫ繝ｼ讀懃衍逕ｨ
            ...
            //{Section::WALKER,{0, 0},Section::TIME,{150},Section::NONE,{}},
            {Section::VIRTUALSTRAIGHT,{-10,21,20,5,2,LineTracer::LEFTEDGE},Section::LENGTH,{6},Section::NONE,{}},
            ...
            {Section::TRACER,{32, 0,  18, 10, 9,0,0,LineTracer::LEFTEDGE},Section::LENGTH,{45},Section::NONE,{}},
            ...
            {Section::VIRTUALSTRAIGHT,{0,17,20,5,2,LineTracer::LEFTEDGE},Section::COLOR,{20,0.5},Section::NONE,{}},//襍､
