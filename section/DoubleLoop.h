...
class DoubleLoop : public SectionManager {
    ...
    private:
        ...
        SecParam spara [100] = {
            ...
            {Section::TRACER,{18, -0.2,  17, 12, 8,0,0,LineTracer::LEFTEDGE},Section::COLOR,{228,0.16},Section::NONE,{}},//髱抵ｿｽ??ｿｽ?ｿｽ??ｿｽ繧ｫ繝ｼ讀懃衍逕ｨ
            ...
            {Section::VIRTUALSTRAIGHT,{0,40,20,5,2,LineTracer::RIGHTEDGE},Section::LENGTH,{90},Section::NONE,{}},
